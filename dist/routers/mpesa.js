...
mpesaRouter.post("/callback", async (req, res) => {
    ...
    try {
        ...
        if (resultCode === 0) {
            ...
            const invoiceId = (_b = invoice._id) === null || _b === void 0 ? void 0 : _b.toString();
            await (0, transaction_1.createTransaction)((_d = (_c = invoice.user) === null || _c === void 0 ? void 0 : _c._id) === null || _d === void 0 ? void 0 : _d.toString(), "mpesa", invoiceId);
...
mpesaRouter.post("/c2b", requireUser_1.requireUser, async (req, res, next) => {
    ...
    try {
        ...
        const lipaNaMpesaOnlinePasskey = process.env
            .MPESA_CUSTOMER_PASSKEY;
        ...
        // create invoice
        await (0, invoice_1.createInvoice)({
            phoneNumber,
            user: userId,
            amount,
            mpesaResponse: data,
    ...
    try {
        ...
        if (ResultType === 0) {
            ...
            if (OriginatorConversationID && ConversationID) {
                ...
                const invoiceId = (_a = invoice._id) === null || _a === void 0 ? void 0 : _a.toString();
                await (0, transaction_1.createTransaction)((_c = (_b = invoice.user) === null || _b === void 0 ? void 0 : _b._id) === null || _c === void 0 ? void 0 : _c.toString(), "mpesa", invoiceId);
                const loan = await (0, loan_1.createLoan)(invoice);
                return res.status(200).json({ message: "Payment successful", loan });
            }
        }
        return res.status(200).send("Received");
    }
...
mpesaRouter.post("/b2c", requireUser_1.requireUser, async (req, res, next) => {
    ...
    try {
        ...
        const SecurityCredential = process.env
            .MPESA_SECURITY_CREDENTILAS;
